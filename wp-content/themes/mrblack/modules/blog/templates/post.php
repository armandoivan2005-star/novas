...
<section id="primary" class="<?php echo esc_attr( mrblack_get_primary_classes() ); ?>">
    ...
    <div class="wdt-posts-list-wrapper"><?php
        ...
        do_action( 'mrblack_before_blog_post_content_wrap' );
        ...
        if( have_posts() ) {
            ...
            $template_args = apply_filters( 'mrblack_blog_archive_order_params', $template_args );
            ...
            echo '<h2>'.esc_html__('Nothing Found.', 'mrblack').'</h2>';
            echo '<p>'.esc_html__('Apologies, but no results were found for the requested archive.', 'mrblack').'</p>';
        }

        do_action( 'mrblack_after_blog_post_content_wrap' );?>
