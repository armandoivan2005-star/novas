...
if( ! function_exists( 'mrblack_shop_woo_loop_product_content' ) ) {

	function mrblack_shop_woo_loop_product_content() {
		...
		if($product_content_enable) {
			...
			if($product_content_content) {
				...
				mrblack_shop_woo_loop_product_content_content_setup($product_content_content);
				...
				echo '<div class="product-details">';
					...
					// Others
					do_action('mrblack_woo_loop_product_content_content', 'content');
					remove_all_actions('mrblack_woo_loop_product_content_content');
	...
	add_action( 'woocommerce_shop_loop_item_title', 'mrblack_shop_woo_loop_product_content', 10 );
