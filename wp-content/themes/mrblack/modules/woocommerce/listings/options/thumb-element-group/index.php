...
if( !class_exists( 'MrBlack_Woo_Listing_Option_Thumb_Element_Group' ) ) {

    class MrBlack_Woo_Listing_Option_Thumb_Element_Group extends MrBlack_Woo_Listing_Option_Core {
        ...
        function render_backend() {
            ...
            add_filter( 'mrblack_woo_custom_product_template_thumb_options', array( $this, 'woo_custom_product_template_thumb_options'), 55, 1 );
        }
...
if( !function_exists('mrblack_woo_listing_option_thumb_element_group') ) {
	function mrblack_woo_listing_option_thumb_element_group() {
		return MrBlack_Woo_Listing_Option_Thumb_Element_Group::instance();
	}
}

mrblack_woo_listing_option_thumb_element_group();