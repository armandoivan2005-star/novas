...
if( !class_exists( 'MrBlack_Shop_Others_Quantity_Plus_Minus' ) ) {

    class MrBlack_Shop_Others_Quantity_Plus_Minus {
        ...
        function __construct() {
            ...
            // JS
                add_action( 'mrblack_after_woo_js', array ( $this, 'after_woo_js' ) );
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( mrblack_is_file_in_theme( __FILE__ ) ) {
                    return MRBLACK_MODULE_DIR . '/woocommerce/others/quantity-plus-minus/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( mrblack_is_file_in_theme( __FILE__ ) ) {
                    return MRBLACK_MODULE_URI . '/woocommerce/others/quantity-plus-minus/';
                } else {
        ...
        */
            function after_woo_js() {
                ...
                if( !is_product() && !is_cart() ) {
                    ...
                    wp_register_script( 'mrblack-woo-quantity-plus-minus', '', array ('jquery'), false, true );
                    wp_enqueue_script( 'mrblack-woo-quantity-plus-minus' );
                    ...
                    if( !empty($js) ) {
                        wp_add_inline_script( 'mrblack-woo-quantity-plus-minus', $js );
                    }
...
if( !function_exists('mrblack_shop_others_quantity_plus_minus') ) {
	function mrblack_shop_others_quantity_plus_minus() {
        $reflection = new ReflectionClass('MrBlack_Shop_Others_Quantity_Plus_Minus');
        return $reflection->newInstanceWithoutConstructor();
	}
}

MrBlack_Shop_Others_Quantity_Plus_Minus::instance();