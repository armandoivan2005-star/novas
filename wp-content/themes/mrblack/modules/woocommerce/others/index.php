...
if( !class_exists( 'MrBlack_Woo_Others' ) ) {

    class MrBlack_Woo_Others {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'mrblack_woo_others_settings', $this->settings );
...
if( !function_exists('mrblack_woo_others') ) {
	function mrblack_woo_others() {
		return MrBlack_Woo_Others::instance();
	}
}
