...
if( !class_exists( 'MrBlack_Woo_Listing_Shop' ) ) {

    class MrBlack_Woo_Listing_Shop {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'mrblack_woo_shop_page_default_settings', $this->settings );
...
if( !function_exists('mrblack_woo_listing_shop') ) {
	function mrblack_woo_listing_shop() {
		return MrBlack_Woo_Listing_Shop::instance();
	}
}

mrblack_woo_listing_shop();