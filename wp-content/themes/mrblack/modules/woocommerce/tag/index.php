...
if( !class_exists( 'MrBlack_Woo_Listing_Tag' ) ) {

    class MrBlack_Woo_Listing_Tag {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'mrblack_woo_tag_page_default_settings', $this->settings );
...
if( !function_exists('mrblack_woo_listing_tag') ) {
	function mrblack_woo_listing_tag() {
		return MrBlack_Woo_Listing_Tag::instance();
	}
}

mrblack_woo_listing_tag();