...
if( !class_exists( 'MrBlack_Shop_Single_Module_Upsell_Related' ) ) {

    class MrBlack_Shop_Single_Module_Upsell_Related {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( mrblack_is_file_in_theme( __FILE__ ) ) {
                    return MRBLACK_MODULE_DIR . '/woocommerce/single/modules/upsell-and-related/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( mrblack_is_file_in_theme( __FILE__ ) ) {
                    return MRBLACK_MODULE_URI . '/woocommerce/single/modules/upsell-and-related/';
                } else {
        ...
        */
            function woo_load_listing( $product_style_template, $product_style_custom_template ) {
                ...
                if( $product_style_template == 'predefined' ) {
                    $type_class_instance = 'mrblack_woo_listing_type_'.$product_style_custom_template; // Type Class Instance
...
if( !function_exists('mrblack_shop_single_module_upsell_related') ) {
	function mrblack_shop_single_module_upsell_related() {
		return MrBlack_Shop_Single_Module_Upsell_Related::instance();
	}
}

mrblack_shop_single_module_upsell_related();