...
if( !class_exists( 'MrBlack_Woo_Single_core' ) ) {

    class MrBlack_Woo_Single_core {
        ...
        function __construct() {
            ...
            // Enqueue CSS
                add_action( 'mrblack_after_woo_css', array ( $this, 'after_woo_css' ), 10 );
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( mrblack_is_file_in_theme( __FILE__ ) ) {
                    return MRBLACK_MODULE_DIR . '/woocommerce/single/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( mrblack_is_file_in_theme( __FILE__ ) ) {
                    return MRBLACK_MODULE_URI . '/woocommerce/single/';
                } else {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = array (
                    ...
                    'product_show_sharer_instagram'         => '',
                    'product_show_sharer_threads'           => ''

                );

                $this->settings = apply_filters( 'mrblack_woo_single_page_settings', $this->settings );
        ...
        */
            function load_modules() {
                ...
                include_once MRBLACK_MODULE_DIR. '/woocommerce/single/includes/template.php';
                include_once MRBLACK_MODULE_DIR. '/woocommerce/single/includes/labels.php';
            ...
            function load_custom_modules() {
                ...
                if( is_array( $custom_modules ) && !empty( $custom_modules ) ) {
                    foreach( $custom_modules as $custom_module ) {
                        ...
                        if( $file_path = mrblack_woo_locate_file( $custom_module ) ) {
        ...
        */
            function after_woo_css() {
                ...
                if( is_product() ) {
                    wp_enqueue_style('mrblack-woo-single-common', $this->module_dir_url() . 'assets/css/common.css');
                }
...
if( !function_exists('mrblack_woo_single_core') ) {
	function mrblack_woo_single_core() {
        $reflection = new ReflectionClass('MrBlack_Woo_Single_core');
        return $reflection->newInstanceWithoutConstructor();
	}
}

MrBlack_Woo_Single_core::instance();