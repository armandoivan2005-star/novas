<?php
/**
 * Plugin Name:	WeDesignTech Elementor Addon
...
if( !class_exists( 'WeDesignTechElementorAddon' ) ) {
    class WeDesignTechElementorAddon {
        ...
        function __construct() {
            ...
            add_action('init', array($this, 'define_translatable_constants'), 11);
		...
		function before_init() {
			$this->define_non_translatable_constants();
			require_once WEDESIGNTECH_ELEMENTOR_ADDON_DIR_PATH . 'helpers/helper.php';
		}

        function define_non_translatable_constants() {
        ...
        function define_translatable_constants(){
        ...
        function generate_core_css() {
            ...
            $css .=  '--wdt-elementor-typo-primary-font-weight: '. (isset(wedesigntech_elementor_global_colors('system_typography', 0)['typography_font_weight']) ? wedesigntech_elementor_global_colors('system_typography', 0)['typography_font_weight'] : '') . ';' . "\n";
            ...
            $css .=  '--wdt-elementor-typo-secondary-font-weight: '.(isset(wedesigntech_elementor_global_colors('system_typography', 1)['typography_font_weight']) ? wedesigntech_elementor_global_colors('system_typography', 1)['typography_font_weight'] : '') . ';' . "\n";
            $css .=  '--wdt-elementor-typo-text-font-family: '.wedesigntech_elementor_global_colors( 'system_typography', 2 )['typography_font_family'].';'."\n";
            $css .=  '--wdt-elementor-typo-text-font-weight: '.(isset(wedesigntech_elementor_global_colors('system_typography', 2)['typography_font_weight']) ? wedesigntech_elementor_global_colors('system_typography', 2)['typography_font_weight'] : '') . ';' . "\n";
            ...
            $css .=  '--wdt-elementor-typo-accent-font-weight: '.(isset(wedesigntech_elementor_global_colors('system_typography', 3)['typography_font_weight']) ? wedesigntech_elementor_global_colors('system_typography', 3)['typography_font_weight'] : '') . ';' . "\n";
