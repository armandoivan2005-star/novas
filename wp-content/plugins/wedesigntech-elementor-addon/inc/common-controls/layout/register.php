...
class WeDesignTech_Common_Controls_Layout {
	...
	public function get_wrapper_start() {
		...
		if($layout == 'carousel') {
			...
			$wrapper_start .= '<div class="wdt-'.esc_attr($module_class).'-holder wdt-content-item-holder wdt-column-holder '.esc_attr($classes_str).'" id="wdt-'.esc_attr($module_class).'-'.esc_attr($module_id).'" data-settings="'.esc_js($settings).'">';
	...
	public function get_item_class() {
		...
		if($layout == 'column') {
			...
			$item_class = 'wdt-default-template';
		}
