...
class WeDesignTech_Widget_Base_Accordion_And_Toggle {
			...
			$this->cc_style->get_style_controls($elementor_object, array (
				...
				'styles' => array (
					'alignment' => array (
                        ...
                        'default' => 'center',
						'selector' => array (
							'{{WRAPPER}} .wdt-accordion-toggle-wrapper' => 'text-align: {{VALUE}}; justify-content: {{VALUE}}; justify-items: {{VALUE}};'
						),
						'condition' => array ()
					),
					'margin' => array (
						'field_type' => 'margin',
						'selector' => array (
							'{{WRAPPER}} .wdt-accordion-toggle-wrapper' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						),
						'condition' => array ()
					),
					'padding' => array (
						'field_type' => 'padding',
						'selector' => array (
							'{{WRAPPER}} .wdt-accordion-toggle-wrapper' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						),
						'condition' => array ()
					),
					'background' => array (
						'field_type' => 'background',
						'selector' => '{{WRAPPER}} .wdt-accordion-toggle-wrapper',
						'condition' => array ()
					),
					'border' => array (
						'field_type' => 'border',
					...
					'border_radius' => array (
						...
						'selector' => array (
							'{{WRAPPER}} .wdt-accordion-toggle-wrapper' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						),
						'condition' => array ()
					),
					'box_shadow' => array (
	...
	public function render_html($widget_object, $settings) {
		...
		if(is_array($settings['item_contents']) && !empty($settings['item_contents'])) {
			...
			$output .= '<div class="wdt-accordion-toggle-holder '.esc_attr(implode(' ', $classes)).'" id="wdt-accordion-and-toggle-'.esc_attr($module_id).'">';
				foreach( $settings['item_contents'] as $key => $item ) {

					if($item['item_type'] == 'default') {

						$output .= '<div class="wdt-accordion-toggle-wrapper">';
							$output .= '<div class="wdt-accordion-toggle-title-holder">';
							...
							$output .= '<div class="wdt-accordion-toggle-description">'.do_shortcode($item['item_description']).'</div>';
						$output .= '</div>';
