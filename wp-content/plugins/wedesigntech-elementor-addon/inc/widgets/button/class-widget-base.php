							...
							'normal' => array (
								...
								'styles' => array (
									...
									'background' => array (
										...
										'selector' => '{{WRAPPER}} .wdt-button-holder .wdt-button',
										'color_selector' => array (
											'{{WRAPPER}} .wdt-button-holder .wdt-button, 
											 {{WRAPPER}} .wdt-button-holder .wdt-button:after' => 'background-color: {{VALUE}};',
											'{{WRAPPER}} .wdt-button-holder.wdt-button-style-underline:after, {{WRAPPER}} .wdt-button-holder.wdt-button-style-overline:after' => 'color: {{VALUE}};'
										),
										'condition' => array ()
									),
									'before_color' => array(
										'field_type' => 'before_color',
										'selector' => '{{WRAPPER}} .wdt-button-holder .wdt-button:before',
										'color_selector' => array(
											'{{WRAPPER}} .wdt-button-holder .wdt-button:before' => 'background-color: {{VALUE}};',
											'{{WRAPPER}} .wdt-button-holder.wdt-button-style-underline:before, {{WRAPPER}} .wdt-button-holder.wdt-button-style-overline:before' => 'color: {{VALUE}};'
										),
										'condition' => array(),
									),
