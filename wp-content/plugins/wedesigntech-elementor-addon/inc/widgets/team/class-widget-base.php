		...
		$elementor_object->start_controls_section( 'wdt_section_settings', array(
			...
			$elementor_object->add_control( 'template', array(
				...
				'options' => array(
					...
					'stage-over' => esc_html__( 'Stage Over', 'wdt-elementor-addon' ),
					'minimal' => esc_html__( 'Minimal', 'wdt-elementor-addon' ),
					'boxed-overlap' => esc_html__( 'Boxed Overlap', 'wdt-elementor-addon' ),
					'modern-overlay' => esc_html__( 'Modern Overlay', 'wdt-elementor-addon' ),
					...
					'tab_items' => array (
						'normal' => array (
							...
							'styles' => array (
								...
								'background' => array (
									...
									'selector' => '{{WRAPPER}} .wdt-content-item, {{WRAPPER}} .wdt-rc-template-boxed .wdt-content-item .wdt-social-icons-list',
									'condition' => array ()
								),
								'border' => array (
									'field_type' => 'border',
						...
						'hover' => array (
							...
							'styles' => array (
								...
								'background' => array (
									'field_type' => 'background',
									'selector' => '{{WRAPPER}} .wdt-content-item:hover, {{WRAPPER}} .wdt-rc-template-boxed .wdt-content-item:hover .wdt-social-icons-list',
									'condition' => array ()
								),
								'border' => array (
									'field_type' => 'border',
		...
		$this->cc_style->get_style_controls($elementor_object, array (
			...
			'styles' => array (
				'media_image_type' => array (
					...
					'condition' => array (
						'template' => array ('default', 'custom-template', 'boxed')
					)
				),
				'alignment' => array (
					'field_type' => 'alignment',
	...
	public function render_html($widget_object, $settings) {
		...
		if( count( $settings['item_contents'] ) > 0 ):
			...
			$output .= $this->cc_layout->get_wrapper_start();
				...
				} else if($settings['template'] == 'stage-over') {
				...
				} else if($settings['template'] == 'boxed-overlap') {
				...
				} else if($settings['template'] == 'modern-overlay') {
