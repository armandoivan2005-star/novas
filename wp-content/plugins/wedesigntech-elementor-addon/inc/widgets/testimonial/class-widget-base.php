...
class WeDesignTech_Widget_Base_Testimonial {
	...
	public function init_styles() {
		return array_merge(
			...
			array (
				'jquery-swiper' =>  WEDESIGNTECH_ELEMENTOR_ADDON_DIR_URL.'inc/widgets/testimonial/assets/css/swiper.min.css',
			...
			'styles' => array (
				...
				'width' => array (
					...
					'selector' => array (
						...
						'{{WRAPPER}} .wdt-content-item-holder.wdt-rc-template-aside-title .wdt-content-item' => '--wdt_imageWidth: {{SIZE}}{{UNIT}};',
					...
					'tab_items' => array (
						'normal' => array (
							...
							'styles' => array (
                                'background' => array (
									'field_type' => 'background',
									'selector' => '{{WRAPPER}} .wdt-content-item .wdt-content-separator span',
									'condition' => array ()
								),
								'border' => array (
									'field_type' => 'border',
								...
								'border_radius' => array (
									'field_type' => 'border_radius',
									'selector' => array (
										'{{WRAPPER}} .wdt-content-item .wdt-content-separator.separator-1 span' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
									),
									'condition' => array ()
								)
							)
						...
						'hover' => array (
							...
							'styles' => array (
                                'background' => array (
									'field_type' => 'background',
									'selector' => '{{WRAPPER}} .wdt-content-item:hover .wdt-content-separator span',
									'condition' => array ()
								),
								'border' => array (
									'field_type' => 'border',
