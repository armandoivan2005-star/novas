		...
		$elementor_object->start_controls_section( 'wdt_section_settings', array(
			...
			$elementor_object->add_control( 'template', array(
				...
				'options' => array(
					...
					'with-interaction' => esc_html__( 'With Interaction', 'wdt-elementor-addon' ),
					'with-instagram'  => esc_html__( 'With Instagram', 'wdt-elementor-addon' ),
					'with-icon' => esc_html__( 'With Icon', 'wdt-elementor-addon' ),
					'with-interaction-image' => esc_html__( 'With Image Interaction', 'wdt-elementor-addon' ),
					'with-interactive-aside-image' => esc_html__( 'With Interaction Aside Image', 'wdt-elementor-addon' ),
					'with-modern-template' => esc_html__( 'With Modern Template', 'wdt-elementor-addon' ),
			...
			$elementor_object->add_control( 'enable_class_on_click', array(
				'label'   => esc_html__( 'Enable Class On Click', 'wdt-elementor-addon' ),
				'type'    => \Elementor\Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'wdt-elementor-addon' ),
                'label_off'    => esc_html__( 'No', 'wdt-elementor-addon' ),
				'return_value' => 'yes',
		...
		$this->cc_style->get_style_controls($elementor_object, array (
			...
			'styles' => array (
				'alignment' => array (
                    ...
                    'default' => 'center',
					'selector' => array (
						'{{WRAPPER}} .wdt-content-title' => 'text-align: {{VALUE}}; justify-content: {{VALUE}}; justify-items: {{VALUE}};'
					),
					'condition' => array ()
				),
				'typography' => array (
		...
		$this->cc_style->get_style_controls($elementor_object, array (
			...
			'styles' => array (
				'media_image_type' => array (
					...
					'condition' => array (
						'template' => array ('default', 'custom-template', 'with-description', 'with-interaction', 'with-instagram', 'with-icon', 'with-interaction-image', 'with-interactive-aside-image', 'with-modern-template')
					)
				),
				'alignment' => array (
					'field_type' => 'alignment',
	...
	public function render_html($widget_object, $settings) {
		...
		if( count( $settings['item_contents'] ) > 0 ):
			...
			$settings['custom_attributes'] = array (
				...
				'enable_class_on_click' => $settings['enable_class_on_click']
			);
			...
			if($settings['enable_class_on_click'] == true) {
				array_push($classes, 'wdt-image-click-active-class');
			}
			...
			$output .= $this->cc_layout->get_wrapper_start();
				...
				} else if($settings['template'] == 'with-interaction') {
				...
				} else if($settings['template'] == 'with-interaction-image') {
				...
				} else if($settings['template'] == 'with-instagram') {
				...
				} else if($settings['template'] == 'with-icon') {
				...
				} else if($settings['template'] == 'with-interactive-aside-image') {
				...
				} else if($settings['template'] == 'with-modern-template') {
