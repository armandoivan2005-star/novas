;(function ( $, window, document, undefined ) {
    'use strict';
    $.MRBLACKPLUSWPCUSTOMIZER = $.MRBLACKPLUSWPCUSTOMIZER || {};

	$.MRBLACKPLUSWPCUSTOMIZER.DEPENDENCY = function( el, param ) {
	...
	$.fn.MRBLACKPLUSWPCUSTOMIZER_DEPENDENCY = function ( param ) {
		return this.each(function () {
			new $.MRBLACKPLUSWPCUSTOMIZER.DEPENDENCY( this, param );
		});
	};

	$(document).ready( function() {
		$('.wp-customizer').MRBLACKPLUSWPCUSTOMIZER_DEPENDENCY();
	});
