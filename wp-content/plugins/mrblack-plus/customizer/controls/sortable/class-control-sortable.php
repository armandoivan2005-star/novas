...
class MrBlack_Customize_Control_Sortable extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'mrblack-plus-sortable-control', MRBLACK_PLUS_DIR_URL.'customizer/controls/sortable/sortable.js', array( 'jquery', 'customize-base' ), MRBLACK_PLUS_VERSION, true );
		wp_enqueue_style( 'mrblack-plus-sortable-control',  MRBLACK_PLUS_DIR_URL.'customizer/controls/sortable/sortable.css', null, MRBLACK_PLUS_VERSION );
	}
