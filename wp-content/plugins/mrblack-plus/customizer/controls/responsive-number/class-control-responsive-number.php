...
class MrBlack_Customize_Control_Responsive_Number extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'mrblack-plus-responsive-number-control', MRBLACK_PLUS_DIR_URL . 'customizer/controls/responsive-number/responsive-number.js', array( 'jquery', 'customize-base' ), MRBLACK_PLUS_VERSION, true );
		wp_enqueue_style( 'mrblack-plus-responsive-number-control',  MRBLACK_PLUS_DIR_URL . 'customizer/controls/responsive-number/responsive-number.css', null, MRBLACK_PLUS_VERSION );
	}
