...
class MrBlack_Customize_Control_Description extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'mrblack-plus-description-control',  MRBLACK_PLUS_DIR_URL.'customizer/controls/description/description.css', null, MRBLACK_PLUS_VERSION );
	}
