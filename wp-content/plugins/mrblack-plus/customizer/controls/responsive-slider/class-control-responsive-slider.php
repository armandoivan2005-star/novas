...
class MrBlack_Customize_Control_Responsive_Slider extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'mrblack-plus-responsive-slider-control', MRBLACK_PLUS_DIR_URL . 'customizer/controls/responsive-slider/responsive-slider.js', array( 'jquery', 'customize-base' ), MRBLACK_PLUS_VERSION, true );
		wp_enqueue_style( 'mrblack-plus-responsive-slider-control',  MRBLACK_PLUS_DIR_URL . 'customizer/controls/responsive-slider/responsive-slider.css', null, MRBLACK_PLUS_VERSION );
	}
