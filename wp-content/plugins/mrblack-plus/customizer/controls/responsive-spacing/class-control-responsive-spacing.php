...
class MrBlack_Customize_Control_Responsive_Spacing extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'mrblack-plus-responsive-spacing-control', MRBLACK_PLUS_DIR_URL.'customizer/controls/responsive-spacing/responsive-spacing.js', array( 'jquery', 'customize-base' ), MRBLACK_PLUS_VERSION, true );
		wp_enqueue_style( 'mrblack-plus-responsive-spacing-control',  MRBLACK_PLUS_DIR_URL.'customizer/controls/responsive-spacing/responsive-spacing.css', null, MRBLACK_PLUS_VERSION );
	}
