<?php
/**
 * Customizer Control: Fontawesome
 *
 */
...
class MrBlack_Customize_Control_Fontawesome extends WP_Customize_Control {

	public $type       = 'wdt-fontawesome';
	...
	public function enqueue() {
		wp_enqueue_script( 'mrblack-plus-fontawesome-control', MRBLACK_PLUS_DIR_URL . 'customizer/controls/fontawesome/fontawesome.js', array( 'jquery', 'customize-base' ), MRBLACK_PLUS_VERSION, true );
		wp_enqueue_style( 'mrblack-plus-fontawesome-control',  MRBLACK_PLUS_DIR_URL . 'customizer/controls/fontawesome/fontawesome.css', null, MRBLACK_PLUS_VERSION );

		wp_enqueue_style( 'mrblack-plus-fontawesome',  MRBLACK_PLUS_DIR_URL . 'customizer/assets/css/fontawesome-all.css', array(),MRBLACK_PLUS_VERSION, 'all' );
	}
	...
	public function to_json() {
		...
		$this->json['reset'] = esc_html__( "Reset", "mrblack-plus") .' '.esc_html( $this->label );
		...
		$icons = array();
		$font_icons = $this->get_font_icons();
		foreach( $font_icons as $class => $name  ) {
