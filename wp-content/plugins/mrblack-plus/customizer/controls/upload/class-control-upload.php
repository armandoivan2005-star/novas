...
class MrBlack_Customize_Control_Upload extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_style( 'mrblack-plus-upload-control',  MRBLACK_PLUS_DIR_URL.'customizer/controls/upload/upload.css', null, MRBLACK_PLUS_VERSION );
		wp_enqueue_script( 'mrblack-plus-upload-control', MRBLACK_PLUS_DIR_URL.'customizer/controls/upload/upload.js', array( 'jquery', 'customize-base' ), MRBLACK_PLUS_VERSION, true );
	}
                ...
                <div class="upload-file">
                    <div class="attachment-file-view upload-file">
                        ...
                        <div class="actions">
                            ...
                            <button type="button" class="button upload-file-button"><?php esc_attr_e( 'Select File', 'mrblack-plus' ); ?></button>
                        </div>
                    </div>
                </div>
			</div>
