...
class MrBlack_Customize_Control_Color extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'mrblack-plus-color-control', MRBLACK_PLUS_DIR_URL.'customizer/controls/color/color.js', array( 'jquery', 'customize-base' , 'mrblack-plus-customizer-color-picker' ), MRBLACK_PLUS_VERSION, true );
		wp_enqueue_style( 'mrblack-plus-color-control',  MRBLACK_PLUS_DIR_URL.'customizer/controls/color/color.css', null, MRBLACK_PLUS_VERSION );
	}
