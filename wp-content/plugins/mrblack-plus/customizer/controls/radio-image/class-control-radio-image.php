...
class MrBlack_Customize_Control_Radio_Image extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'mrblack-plus-radio-image-control', MRBLACK_PLUS_DIR_URL . 'customizer/controls/radio-image/radio-image.js', array( 'jquery', 'customize-base' ), MRBLACK_PLUS_VERSION, true );
		wp_enqueue_style( 'mrblack-plus-radio-image-control',  MRBLACK_PLUS_DIR_URL . 'customizer/controls/radio-image/radio-image.css', null, MRBLACK_PLUS_VERSION );
	}
