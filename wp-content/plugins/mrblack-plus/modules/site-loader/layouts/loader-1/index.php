...
if( !class_exists( 'MrBlackPlusSiteLoaderOne' ) ) {
    class MrBlackPlusSiteLoaderOne {
        ...
        function add_option( $options ) {
            $options['loader-1'] = esc_html__('Loader 1', 'mrblack-plus');
            return $options;
        }

        function enqueue_assets() {
            wp_enqueue_style( 'site-loader', MRBLACK_PLUS_DIR_URL . 'modules/site-loader/layouts/loader-1/assets/css/loader-1.css', false, MRBLACK_PLUS_VERSION, 'all' );
        }
...
MrBlackPlusSiteLoaderOne::instance();