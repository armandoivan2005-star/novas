...
if( !class_exists( 'MrBlackPlusSiteCustomLoader' ) ) {
    class MrBlackPlusSiteCustomLoader {
        ...
        function add_option( $options ) {
            $options['custom-loader'] = esc_html__('Custom Loader', 'mrblack-plus');
            return $options;
        }

        function enqueue_assets() {
            wp_enqueue_style( 'site-loader', MRBLACK_PLUS_DIR_URL . 'modules/site-loader/layouts/custom-loader/assets/css/custom-loader.css', false, MRBLACK_PLUS_VERSION, 'all' );
        }
...
MrBlackPlusSiteCustomLoader::instance();