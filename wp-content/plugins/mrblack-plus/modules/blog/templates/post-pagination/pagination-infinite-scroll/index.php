...
if( !class_exists( 'BlogPaginationInfiniteScroll' ) ) {
    class BlogPaginationInfiniteScroll {
        ...
        function enqueue_js_assets() {
        	wp_enqueue_script( 'post-infinite', MRBLACK_PLUS_DIR_URL . 'modules/blog/assets/js/post-infinite.js', array(), MRBLACK_PLUS_VERSION, true );
			wp_localize_script('post-infinite', 'mrblack_urls', array(
