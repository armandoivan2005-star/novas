...
if( !class_exists( 'MrBlackPlusCustomizerSiteTitle' ) ) {
    class MrBlackPlusCustomizerSiteTitle {
        ...
        function register( $wp_customize ) {
            ...
            $wp_customize->add_section(
                new MrBlack_Customize_Section(
                    ...
                    'site-title-section',
                    array(
                        'title'    => esc_html__('Site Title', 'mrblack-plus'),
            ...
            if ( ! defined( 'MRBLACK_PRO_VERSION' ) ) {
                $wp_customize->add_control(
                    new MrBlack_Customize_Control_Separator(
                        $wp_customize, MRBLACK_CUSTOMISER_VAL . '[mrblack-plus-site-title-separator]',
                        array(
                            'type'        => 'wdt-separator',
...
MrBlackPlusCustomizerSiteTitle::instance();