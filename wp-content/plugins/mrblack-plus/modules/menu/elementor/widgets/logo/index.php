...
if( !class_exists( 'MrBlackPlusLogoWidget' ) ) {
    class MrBlackPlusLogoWidget {
        ...
        function register_widgets( $widgets_manager ) {
            require MRBLACK_PLUS_DIR_PATH. 'modules/menu/elementor/widgets/logo/class-widget-logo.php';
            $widgets_manager->register( new \Elementor_logo() );
        }

        function register_widget_styles() {
            wp_register_style( 'wdt-logo',
                MRBLACK_PLUS_DIR_URL . 'modules/menu/elementor/widgets/assets/css/logo.css', array(), MRBLACK_PLUS_VERSION );
        }
...
MrBlackPlusLogoWidget::instance();