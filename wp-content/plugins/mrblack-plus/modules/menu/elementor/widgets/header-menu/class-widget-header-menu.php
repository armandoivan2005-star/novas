...
class Elementor_Header_Menu extends MrBlackElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Header Menu', 'mrblack-plus');
    }
    ...
    protected function register_controls() {
		...
		$nav_menus = array( 0 => esc_html__('Select Menu', 'mrblack-plus')  );
        ...
        $this->start_controls_section( 'wdt_section_general', array(
            ...
            $this->add_control( 'nav_type', array(
				...
				'label'   => esc_html__('Navigation Type', 'mrblack-plus'),
				'default' => 'primary-nav',
				'options' => array(
                    'primary-nav' => esc_html__('Primary Nav','mrblack-plus'),
                    'secondary-nav' => esc_html__('Secondary Nav','mrblack-plus')
                )
            ) );

            $this->add_control( 'nav_id', array(
				'type'    => Controls_Manager::SELECT,
				'label'   => esc_html__('Choose Menu', 'mrblack-plus'),
				'default' => '0',
				'options' => $nav_menus
            ) );
        ...
        $this->start_controls_section( 'wdt_section_typography', array(
        	'label'      => esc_html__( 'Menu', 'mrblack-plus' ),
			'tab'        => Controls_Manager::TAB_STYLE,
			'show_label' => false,
		) );

			$this->add_group_control( Group_Control_Typography::get_type(), array(
                'label'      => esc_html__( 'Menu Typography', 'mrblack-plus' ),
			...
			$this->add_group_control( Group_Control_Typography::get_type(), array(
                'label'      => esc_html__( 'Sub Menu Typography', 'mrblack-plus' ),
        ...
        $this->start_controls_section( 'wdt_section_color', array(
			...
			$this->add_control( 'menu_color', array(
				'label'     => esc_html__( 'Menu Color', 'mrblack-plus' ),
			...
			$this->add_control( 'menu_hover_color', array(
				'label'     => esc_html__( 'Menu Hover Color', 'mrblack-plus' ),
				'type'      => Controls_Manager::COLOR,
				'default' 	=> '',
				'selectors' => array( '
			...
			$this->add_control( 'sub_menu_color', array(
				'label'     => esc_html__( 'Sub Menu Color', 'mrblack-plus' ),
				'type'      => Controls_Manager::COLOR,
				'default' 	=> '',
			...
			$this->add_control( 'sub_menu_hover_color', array(
				'label'     => esc_html__( 'Sub Menu Hover Color', 'mrblack-plus' ),
				'type'      => Controls_Manager::COLOR,
				'default' 	=> '',
				'selectors' => array( '
    ...
    protected function render() {
        ...
        $navigation = wp_nav_menu( array(
			...
			'link_after'      => '</span>',
            'walker'          => new MrBlack_Walker_Nav_Menu,
            'echo'            => false
        ) );
            ...
            if($nav_type == 'primary-nav') {
                $out .= '<div class="mobile-nav-container mobile-nav-offcanvas-right" data-menu="'.esc_attr( $nav_id ).'">';
                    $out .= '<a href="#" class="menu-trigger menu-trigger-icon" data-menu="'.esc_attr( $nav_id ).'">';
                        $out .= '<i></i>';
                        $out .= '<span>'.esc_html__('Menu', 'mrblack-plus').'</span>';
                    $out .= '</a>';
