...
if( !class_exists( 'MrBlackPlusHeaderElementor' ) ) {
    class MrBlackPlusHeaderElementor {
        ...
        function frontend() {
            add_filter( 'mrblack_print_header_template', array( $this, 'register_header_template' ), 10, 1 );
        }
		...
		function register_header_template( $id ) {
            ...
            echo '<div class="'.esc_attr($class).'">';
                echo '<div id="header-'.esc_attr( $id ).'" class="wdt-header-tpl header-' .esc_attr( $id ). '">';
                    ...
                    if( class_exists( '\Elementor\Core\Files\CSS\Post' ) ) {
                        ...
                        echo mrblack_html_output($elementor_instance->frontend->get_builder_content_for_display( $id ));
                    } else {
                        $header = get_post( $id );
            ...
            return apply_filters( 'mrblack_plus_header_content', $content );
		}
    }
}

MrBlackPlusHeaderElementor::instance();