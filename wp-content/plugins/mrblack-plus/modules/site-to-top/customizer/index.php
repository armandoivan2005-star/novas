...
if( !class_exists( 'MrBlackPlusCustomizerSiteToTop' ) ) {
    class MrBlackPlusCustomizerSiteToTop {
        ...
        function register_general( $wp_customize ) {
            ...
            $wp_customize->add_section(
                new MrBlack_Customize_Section(
                    ...
                    'site-to-top-section',
                    array(
                        'title'    => esc_html__('To Top', 'mrblack-plus'),
                ...
                $wp_customize->add_setting(
                    MRBLACK_CUSTOMISER_VAL . '[show_site_to_top]', array(
                        'type' => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new MrBlack_Customize_Control_Switch(
                        $wp_customize, MRBLACK_CUSTOMISER_VAL . '[show_site_to_top]', array(
                            'type'    => 'wdt-switch',
                            'section' => 'site-to-top-section',
                            'label'   => esc_html__( 'Enable To Top', 'mrblack-plus' ),
                            'choices' => array(
...
MrBlackPlusCustomizerSiteToTop::instance();