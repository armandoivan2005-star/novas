...
if( !class_exists( 'MrBlackPlusFooterElementor' ) ) {
    class MrBlackPlusFooterElementor {
        ...
        function frontend() {
            add_filter( 'mrblack_print_footer_template', array( $this, 'register_footer_template' ), 10, 1 );
        }
		...
		function register_footer_template( $id ) {
            ...
            return apply_filters( 'mrblack_plus_footer_content', $content );
		}
    }
}

MrBlackPlusFooterElementor::instance();