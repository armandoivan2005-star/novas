...
if( !class_exists( 'MrBlackPlusSidebar' ) ) {
    class MrBlackPlusSidebar {
        ...
        function load_modules() {
            include_once MRBLACK_PLUS_DIR_PATH.'modules/sidebar/customizer/index.php';
        }

        function frontend() {
            add_filter('mrblack_primary_classes', array( $this, 'primary_classes' ), 10 );
            add_filter('mrblack_secondary_classes', array( $this, 'secondary_classes' ), 10 );
        }
