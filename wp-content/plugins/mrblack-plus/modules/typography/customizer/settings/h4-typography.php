...
if( !class_exists( 'MrBlackPlusH4Settings' ) ) {
    class MrBlackPlusH4Settings {
        ...
        function __construct() {
            $this->selector = apply_filters( 'mrblack_h4_selector', array( 'h4' ) );
            $this->settings = mrblack_customizer_settings('h4_typo');

            add_filter( 'mrblack_plus_customizer_default', array( $this, 'default' ) );
            add_action( 'customize_register', array( $this, 'register' ), 20);

            add_filter( 'mrblack_h4_typo_customizer_update', array( $this, 'h4_typo_customizer_update' ) );
        ...
        function register( $wp_customize ) {
            ...
            $wp_customize->add_section(
                new MrBlack_Customize_Section(
                    ...
                    'site-h4-section',
                    array(
                        'title'    => esc_html__('H4 Typography', 'mrblack-plus'),
             ...
             */
                $wp_customize->add_setting(
                    MRBLACK_CUSTOMISER_VAL . '[h4_typo]', array(
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new MrBlack_Customize_Control_Typography(
                        $wp_customize, MRBLACK_CUSTOMISER_VAL . '[h4_typo]', array(
                            'type'    => 'wdt-typography',
                            'section' => 'site-h4-section',
                            'label'   => esc_html__( 'H4 Tag', 'mrblack-plus'),
                        )
                    )
                );
             ...
             */
                $wp_customize->add_setting(
                    MRBLACK_CUSTOMISER_VAL . '[h4_color]', array(
                        'default' => '',
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new WP_Customize_Color_Control(
                        $wp_customize, MRBLACK_CUSTOMISER_VAL . '[h4_color]', array(
        ...
        function h4_typo_customizer_update( $defaults ) {
            $h4_typo = mrblack_customizer_settings( 'h4_typo' );
            if( !empty( $h4_typo ) ) {
                return  $h4_typo;
            }
            return $defaults;
        ...
        function base_style( $style ) {
            $css   = '';
            $color = mrblack_customizer_settings('h4_color');
...
MrBlackPlusH4Settings::instance();