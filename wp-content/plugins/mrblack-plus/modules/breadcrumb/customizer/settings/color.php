...
if( !class_exists( 'MrBlackPlusBreadCrumbColor' ) ) {
    class MrBlackPlusBreadCrumbColor {
        ...
        function register( $wp_customize ) {
            ...
            $wp_customize->add_section(
                new MrBlack_Customize_Section(
                    ...
                    array(
                        'title'    => esc_html__('Colors & Background', 'mrblack-plus'),
            ...
            if ( ! defined( 'MRBLACK_PRO_VERSION' ) ) {
                $wp_customize->add_control(
                    new MrBlack_Customize_Control_Separator(
                        $wp_customize, MRBLACK_CUSTOMISER_VAL . '[mrblack-plus-site-breadcrumb-color-separator]',
                        array(
                            'type'        => 'wdt-separator',
...
MrBlackPlusBreadCrumbColor::instance();