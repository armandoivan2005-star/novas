...
if( !class_exists( 'MrBlackPlusBreadCrumbTypo' ) ) {
    class MrBlackPlusBreadCrumbTypo {
        ...
        function register( $wp_customize ) {
            $wp_customize->add_section(
                new MrBlack_Customize_Section(
                    ...
                    array(
                        'title'    => esc_html__('Typography', 'mrblack-plus'),
                ...
                if ( ! defined( 'MRBLACK_PRO_VERSION' ) ) {
                    $wp_customize->add_control(
                        new MrBlack_Customize_Control_Separator(
                            $wp_customize, MRBLACK_CUSTOMISER_VAL . '[mrblack-plus-site-breadcrumb-typo-separator]',
                            array(
                                'type'        => 'wdt-separator',
...
MrBlackPlusBreadCrumbTypo::instance();