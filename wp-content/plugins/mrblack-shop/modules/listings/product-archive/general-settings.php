...
if( !class_exists( 'MrBlack_Woo_Listing_Fw_Archive_General_Settings' ) ) {

    class MrBlack_Woo_Listing_Fw_Archive_General_Settings {
        ...
        function __construct($shop_custom_options) {
            ...
            /* Update Archive Default Options */
                add_filter( 'mrblack_woo_shop_page_default_settings', array( $this, 'shop_page_default_settings' ), 20, 1 );
