...
if( !class_exists( 'MrBlack_Woo_Listing_Fw_Archive_Hook_Settings' ) ) {

    class MrBlack_Woo_Listing_Fw_Archive_Hook_Settings {
        ...
        function __construct($shop_custom_options) {
            ...
            remove_action( 'mrblack_hook_sections_before', array (mrblack_woo_listing_fw_hooks_settings(), 'woo_hook_sections_before'), 10 );
            remove_action( 'mrblack_hook_sections_after', array (mrblack_woo_listing_fw_hooks_settings(), 'woo_hook_sections_after'), 10 );
            remove_action( 'mrblack_woo_before_products_loop', array (mrblack_woo_listing_fw_hooks_settings(), 'woo_before_products_loop'), 15 );
            remove_action( 'mrblack_woo_after_products_loop', array (mrblack_woo_listing_fw_hooks_settings(), 'woo_after_products_loop'), 5 );
