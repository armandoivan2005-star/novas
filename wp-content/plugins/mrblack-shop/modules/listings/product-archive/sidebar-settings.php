...
if( !class_exists( 'MrBlack_Woo_Listing_Fw_Archive_Sidebar_Settings' ) ) {

    class MrBlack_Woo_Listing_Fw_Archive_Sidebar_Settings {
        ...
        function frontend() {
            add_filter('mrblack_primary_classes', array( $this, 'primary_classes' ), 50 );
            add_filter('mrblack_secondary_classes', array( $this, 'secondary_classes' ), 50 );
            add_filter('mrblack_active_sidebars', array( $this, 'active_sidebars' ), 50 );
            add_filter('mrblack_woo_loop_column_class', array( $this, 'woo_loop_column_class' ), 50, 2 );
        }
