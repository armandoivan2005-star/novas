...
class CSFramework_Metabox extends CSFramework_Abstract{
  ...
  public function render_meta_box_content( $post, $callback ) {
    ...
    $cs_errors  = isset( $transient['errors'] ) ? $transient['errors'] : '';
          ...
          echo '<div class="cs-nav">';
            ...
            foreach( $sections as $value ) {
              ...
              if( isset( $value['fields'] ) ) {
                ...
                echo '<li><a href="#"'. esc_attr($active_section) .' data-section="'. esc_attr($value['name']) .'">'. $tab_icon . $value['title'] .'</a></li>';
              } else {
        ...
        echo '<div class="cs-content">';
          ...
          foreach( $sections as $v ) {
            ...
            if( isset( $v['fields'] ) ) {
              ...
              echo '<div id="cs-tab-'. $v['name'] .'" class="cs-section"'. mrblack_html_output($active_content) .'>';
