...
if( !class_exists( 'MrBlackProWidgetTitleSettings' ) ) {
    class MrBlackProWidgetTitleSettings {
        ...
        function __construct() {
            $this->selector = apply_filters( 'mrblack_widget_title_selector', array( '.secondary-sidebar .widgettitle' ) );
            $this->settings = mrblack_customizer_settings('widget_title_typo');
            ...
            add_filter( 'mrblack_widget_before_title_tag', array( $this, 'before_title' ));
            add_filter( 'mrblack_widget_after_title_tag', array( $this, 'after_title' ));
        }
        ...
        function register( $wp_customize ){
             ...
             */
                $wp_customize->add_setting(
                    MRBLACK_CUSTOMISER_VAL . '[widget_title_tag]', array(
                        'type' => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    MRBLACK_CUSTOMISER_VAL . '[widget_title_tag]', array(
                        ...
                        'label'   => esc_html__( 'Title Tag', 'mrblack-pro' ),
                        'choices' => array(
                            'h2'   => 'h2',
                            'h3'   => 'h3',
                            'h4'   => 'h4',
             ...
             */
            $wp_customize->add_setting(
                MRBLACK_CUSTOMISER_VAL . '[widget_title_color]', array(
                    'type'    => 'option',
                )
            );
            ...
            $wp_customize->add_control(
                new MrBlack_Customize_Control_Color(
                    $wp_customize, MRBLACK_CUSTOMISER_VAL . '[widget_title_color]', array(
                        'section' => 'site-widgets-title-style-section',
             ...
             */
            $wp_customize->add_setting(
                MRBLACK_CUSTOMISER_VAL . '[widget_title_typo]', array(
                    'type'    => 'option',
                )
            );
            ...
            $wp_customize->add_control(
                new MrBlack_Customize_Control_Typography(
                    $wp_customize, MRBLACK_CUSTOMISER_VAL . '[widget_title_typo]', array(
                        'type'    => 'wdt-typography',
                        'section' => 'site-widgets-title-style-section',
                        'label'   => esc_html__( 'Title Typography', 'mrblack-pro'),
                    )
                )
            );
        ...
        function base_style( $style ) {
            $css   = '';
            $color = mrblack_customizer_settings('widget_title_color');
        ...
        function before_title( $tag ) {
            $t = mrblack_customizer_settings('widget_title_tag');
            if( !empty( $t ) ){
...
MrBlackProWidgetTitleSettings::instance();