...
if( !class_exists( 'MrBlack_Shop_Single_Module_Buy_Now' ) ) {

    class MrBlack_Shop_Single_Module_Buy_Now {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( mrblack_is_file_in_theme( __FILE__ ) ) {
                    return MRBLACK_MODULE_DIR . '/woocommerce/single/modules/buy-now/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( mrblack_is_file_in_theme( __FILE__ ) ) {
                    return MRBLACK_MODULE_URI . '/woocommerce/single/modules/buy-now/';
                } else {
...
if( !function_exists('mrblack_shop_single_module_buy_now') ) {
	function mrblack_shop_single_module_buy_now() {
        $reflection = new ReflectionClass('MrBlack_Shop_Single_Module_Buy_Now');
        return $reflection->newInstanceWithoutConstructor();
	}
}

if( class_exists( 'MrBlack_Shop_Single_Module_Custom_template' ) ) {
    MrBlack_Shop_Single_Module_Buy_Now::instance();
}