...
if( !class_exists( 'MrBlack_Shop_Metabox_Single_Additional_Tabs' ) ) {
    class MrBlack_Shop_Metabox_Single_Additional_Tabs {
        ...
        function mrblack_shop_product_custom_settings( $options ) {
			...
			$product_options = array (
				...
				array (
					...
					'type'            => 'group',
					'title'           => esc_html__('Additional Tabs', 'mrblack-pro'),
					'info'            => esc_html__('Click button to add title and description.', 'mrblack-pro'),
					'button_title'    => esc_html__('Add New Tab', 'mrblack-pro'),
					'accordion_title' => esc_html__('Adding New Tab Field', 'mrblack-pro'),
					'fields'          => array (
						...
						array (
							...
							'info'       => esc_html__('Choose "Elementor Templates" here to use for "Description", if you choose "Custom Description" option you can provide your own content below.', 'mrblack-pro'),
...
MrBlack_Shop_Metabox_Single_Additional_Tabs::instance();