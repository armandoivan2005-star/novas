...
class MrBlack_Shop_Elementor_Single_Count_Down_Timer_Widgets {
	...
	function mrblack_shop_load_cmrblack_modules() {
		...
		require mrblack_shop_single_module_count_down_timer()->module_dir_path() . 'elementor/utils.php';
	...
	function mrblack_shop_register_widget_styles( $suffix ) {
		...
		wp_register_style( 'wdt-shop-coundown-timer',
			mrblack_shop_single_module_count_down_timer()->module_dir_url() . 'assets/css/style'.$suffix.'.css',
			array()
		);
	...
	function mrblack_shop_register_widget_scripts( $suffix ) {
		...
		wp_register_script( 'jquery-downcount',
			mrblack_shop_single_module_count_down_timer()->module_dir_url() . 'assets/js/jquery.downcount'.$suffix.'.js',
			array( 'jquery' ),
			false,
			true
		);
		...
		wp_register_script( 'wdt-shop-coundown-timer',
			mrblack_shop_single_module_count_down_timer()->module_dir_url() . 'assets/js/scripts'.$suffix.'.js',
			array( 'jquery' ),
			false,
			true
		);
...
MrBlack_Shop_Elementor_Single_Count_Down_Timer_Widgets::instance();