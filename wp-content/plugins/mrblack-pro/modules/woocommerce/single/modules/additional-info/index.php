...
if( !class_exists( 'MrBlack_Shop_Single_Module_Additional_Info' ) ) {

    class MrBlack_Shop_Single_Module_Additional_Info {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( mrblack_is_file_in_theme( __FILE__ ) ) {
                    return MRBLACK_MODULE_DIR . '/woocommerce/single/modules/additional-info/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( mrblack_is_file_in_theme( __FILE__ ) ) {
                    return MRBLACK_MODULE_URI . '/woocommerce/single/modules/additional-info/';
                } else {
...
if( !function_exists('mrblack_shop_single_module_additional_info') ) {
	function mrblack_shop_single_module_additional_info() {
        $reflection = new ReflectionClass('MrBlack_Shop_Single_Module_Additional_Info');
        return $reflection->newInstanceWithoutConstructor();
	}
}

if( class_exists( 'MrBlack_Shop_Single_Module_Custom_template' ) ) {
    MrBlack_Shop_Single_Module_Additional_Info::instance();
}