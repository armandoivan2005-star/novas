...
if( !class_exists( 'MrBlack_Shop_Single_Module_Ajax_Cart' ) ) {

    class MrBlack_Shop_Single_Module_Ajax_Cart {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( mrblack_is_file_in_theme( __FILE__ ) ) {
                    return MRBLACK_MODULE_DIR . '/woocommerce/single/modules/ajax-cart/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( mrblack_is_file_in_theme( __FILE__ ) ) {
                    return MRBLACK_MODULE_URI . '/woocommerce/single/modules/ajax-cart/';
                } else {
...
if( !function_exists('mrblack_shop_single_module_ajax_cart') ) {
	function mrblack_shop_single_module_ajax_cart() {
		return MrBlack_Shop_Single_Module_Ajax_Cart::instance();
	}
}

mrblack_shop_single_module_ajax_cart();