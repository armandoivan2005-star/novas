...
if(!function_exists('mrblack_shop_product_tabs_exploded_html')) {
	function mrblack_shop_product_tabs_exploded_html($attrs, $content = null) {
		...
		$attrs = shortcode_atts ( array (
			...
			'scroll_height' => '',
			'class'         => ''
		), $attrs, 'mrblack_shop_product_tabs_exploded' );

		$out = mrblack_shop_product_tabs_exploded_render_html($attrs);

		return $out;

	}
	add_shortcode( 'mrblack_shop_product_tabs_exploded', 'mrblack_shop_product_tabs_exploded_html' );
}


if(!function_exists('mrblack_shop_product_tabs_exploded_render_html')) {
	function mrblack_shop_product_tabs_exploded_render_html($settings) {
