...
class MrBlack_Shop_Widget_Product_Tabs_Exploded extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Product Single - Tabs Exploded', 'mrblack-pro' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section( 'product_tabs_exploded_section', array(
			...
			$this->add_control( 'tab', array(
				...
				'default'     => 'description',
				'options'     => array(
					'description'            => esc_html__( 'Description', 'mrblack-pro' ),
					'review'                 => esc_html__( 'Review', 'mrblack-pro' ),
					'additional_information' => esc_html__( 'Additional Information', 'mrblack-pro' )
				),
			) );
	...
	protected function render() {
		...
		$output = mrblack_shop_product_tabs_exploded_render_html($settings);
