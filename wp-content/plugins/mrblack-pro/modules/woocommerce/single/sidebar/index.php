...
if( !class_exists( 'MrBlack_Pro_Woo_single_Sidebar' ) ) {
    class MrBlack_Pro_Woo_single_Sidebar {
        ...
        function frontend() {
            ...
            add_filter('mrblack_active_sidebars', array( $this, 'active_sidebars' ), 30 );
        }
        ...
        function primary_classes( $primary_class ) {
            ...
            if( is_product() ) {
                ...
                $settings = get_post_meta( $post_id, '_mrblack_layout_settings', true );
...
MrBlack_Pro_Woo_single_Sidebar::instance();