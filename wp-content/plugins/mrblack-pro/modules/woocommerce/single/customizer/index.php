...
if( !class_exists( 'MrBlack_Pro_Customizer_Single' ) ) {

    class MrBlack_Pro_Customizer_Single {
        ...
        function default( $option ) {
            ...
            $option['wdt-single-product-show-sharer-instagram']      = $product_show_sharer_instagram;
            $option['wdt-single-product-show-sharer-threads']        = $product_show_sharer_threads;
        ...
        function register( $wp_customize ) {
            ...
            $wp_customize->add_panel(
                new MrBlack_Customize_Panel(
                    ...
                    array(
                        'title'    => esc_html__('Product Single Page', 'mrblack-pro'),
                ...
                $wp_customize->add_section(
                    new MrBlack_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Default Settings', 'mrblack-pro'),
                ...
                $wp_customize->add_section(
                    new MrBlack_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Upsell Settings', 'mrblack-pro'),
                            'panel'    => 'woocommerce-single-page-section',
                            'priority' => 20,
                        )
                    )
                ...
                $wp_customize->add_section(
                    new MrBlack_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Related Settings', 'mrblack-pro'),
                            'panel'    => 'woocommerce-single-page-section',
                            'priority' => 30,
                        )
                    )
                ...
                $wp_customize->add_section(
                    new MrBlack_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Sociable Share Settings', 'mrblack-pro'),
                            'panel'    => 'woocommerce-single-page-section',
                            'priority' => 40,
                        )
                    )
                ...
                $wp_customize->add_section(
                    new MrBlack_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Sociable Follow Settings', 'mrblack-pro'),
                            'panel'    => 'woocommerce-single-page-section',
                            'priority' => 50,
                        )
                    )
...
if( !function_exists('mrblack_customizer_single') ) {
	function mrblack_customizer_single() {
		return MrBlack_Pro_Customizer_Single::instance();
	}
}

mrblack_customizer_single();