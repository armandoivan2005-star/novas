...
if( !class_exists( 'MrBlack_Woo_Listing_Type_Custom' ) ) {

    class MrBlack_Woo_Listing_Type_Custom {
        ...
        function __construct() {
            ...
            /* Initialize Type */
                ...
                $this->type_name = esc_html__('Custom', 'mrblack-pro');
        ...
        */
            function set_type_options() {
                ...
                if( strpos($this->custom_template, 'predefined-template-') !== false ) {
                    ...
                    $field_key = str_replace('predefined-template-', 'mrblack-woo-product-style-template-',  $this->custom_template);
                    ...
                    $custom_options = ( isset($dtcs_product_templates['mrblack-woo-product-style-templates'][$field_key]) && !empty($dtcs_product_templates['mrblack-woo-product-style-templates'][$field_key]) ) ? $dtcs_product_templates['mrblack-woo-product-style-templates'][$field_key] : array ();
            ...
            function for_non_archive_listing() {
                ...
                /* Assets Load */
                    ...
                    // CSS
                        ...
                        wp_register_style( 'mrblack-woo-non-archive', '', array (), MRBLACK_PRO_VERSION, 'all' );
...
if( !function_exists('mrblack_woo_listing_type_custom') ) {
	function mrblack_woo_listing_type_custom() {
		return MrBlack_Woo_Listing_Type_Custom::instance();
	}
}

mrblack_woo_listing_type_custom();