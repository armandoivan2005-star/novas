...
if( !class_exists( 'MrBlack_Shop_Others_Wishlist' ) ) {

    class MrBlack_Shop_Others_Wishlist {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( mrblack_is_file_in_theme( __FILE__ ) ) {
                    return MRBLACK_MODULE_DIR . '/woocommerce/others/wishlist/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( mrblack_is_file_in_theme( __FILE__ ) ) {
                    return MRBLACK_MODULE_URI . '/woocommerce/others/wishlist/';
                } else {
...
if( !function_exists('mrblack_shop_others_wishlist') ) {
	function mrblack_shop_others_wishlist() {
        $reflection = new ReflectionClass('MrBlack_Shop_Others_Wishlist');
        return $reflection->newInstanceWithoutConstructor();
	}
}

MrBlack_Shop_Others_Wishlist::instance();