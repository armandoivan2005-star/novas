...
if( !class_exists( 'MrBlack_Shop_Others_Suggested_Products' ) ) {

    class MrBlack_Shop_Others_Suggested_Products {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( mrblack_is_file_in_theme( __FILE__ ) ) {
                    return MRBLACK_MODULE_DIR . '/woocommerce/others/suggested-products/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( mrblack_is_file_in_theme( __FILE__ ) ) {
                    return MRBLACK_MODULE_URI . '/woocommerce/others/suggested-products/';
                } else {
...
if( !function_exists('mrblack_shop_others_suggested_products') ) {
	function mrblack_shop_others_suggested_products() {
        $reflection = new ReflectionClass('MrBlack_Shop_Others_Suggested_Products');
        return $reflection->newInstanceWithoutConstructor();
	}
}

MrBlack_Shop_Others_Suggested_Products::instance();