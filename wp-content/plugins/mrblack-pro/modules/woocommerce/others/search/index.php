...
if( !class_exists( 'MrBlack_Shop_Others_Search' ) ) {

    class MrBlack_Shop_Others_Search {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( mrblack_is_file_in_theme( __FILE__ ) ) {
                    return MRBLACK_MODULE_DIR . '/woocommerce/others/search/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( mrblack_is_file_in_theme( __FILE__ ) ) {
                    return MRBLACK_MODULE_URI . '/woocommerce/others/search/';
                } else {
         ...
         */
            function module_add_new_page_template( $templates ) {
                ...
                $templates = array_merge (
                    $templates,
                    array (
                        'tpl-product-search-listing.php' => esc_html__('Product Search Listing Template', 'mrblack-pro')
                    )
                );
...
if( !function_exists('mrblack_shop_others_search') ) {
	function mrblack_shop_others_search() {
        $reflection = new ReflectionClass('MrBlack_Shop_Others_Search');
        return $reflection->newInstanceWithoutConstructor();
	}
}

MrBlack_Shop_Others_Search::instance();