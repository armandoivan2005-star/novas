...
if( !class_exists( 'MrBlack_Shop_Others_Cart' ) ) {

    class MrBlack_Shop_Others_Cart {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( mrblack_is_file_in_theme( __FILE__ ) ) {
                    return MRBLACK_MODULE_DIR . '/woocommerce/others/cart/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( mrblack_is_file_in_theme( __FILE__ ) ) {
                    return MRBLACK_MODULE_URI . '/woocommerce/others/cart/';
                } else {
...
if( !function_exists('mrblack_shop_others_cart') ) {
	function mrblack_shop_others_cart() {
        $reflection = new ReflectionClass('MrBlack_Shop_Others_Cart');
        return $reflection->newInstanceWithoutConstructor();
	}
}

MrBlack_Shop_Others_Cart::instance();