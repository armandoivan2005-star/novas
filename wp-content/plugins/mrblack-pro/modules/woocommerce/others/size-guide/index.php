...
if( !class_exists( 'MrBlack_Shop_Others_Size_Guide' ) ) {

    class MrBlack_Shop_Others_Size_Guide {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( mrblack_is_file_in_theme( __FILE__ ) ) {
                    return MRBLACK_MODULE_DIR . '/woocommerce/others/size-guide/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( mrblack_is_file_in_theme( __FILE__ ) ) {
                    return MRBLACK_MODULE_URI . '/woocommerce/others/size-guide/';
                } else {
...
if( !function_exists('mrblack_shop_others_size_guide') ) {
	function mrblack_shop_others_size_guide() {
        $reflection = new ReflectionClass('MrBlack_Shop_Others_Size_Guide');
        return $reflection->newInstanceWithoutConstructor();
	}
}

MrBlack_Shop_Others_Size_Guide::instance();