...
if( !class_exists( 'MrBlack_Shop_Others_Recently_Viewed_Products' ) ) {

    class MrBlack_Shop_Others_Recently_Viewed_Products {
        ...
        function __construct() {
            ...
            // Enqueue CSS
                add_action( 'mrblack_before_woo_css', array ( $this, 'before_woo_css' ), 10 );
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( mrblack_is_file_in_theme( __FILE__ ) ) {
                    return MRBLACK_MODULE_DIR . '/woocommerce/others/recently-viewed-products/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( mrblack_is_file_in_theme( __FILE__ ) ) {
                    return MRBLACK_MODULE_URI . '/woocommerce/others/recently-viewed-products/';
                } else {
...
if( !function_exists('mrblack_shop_others_recently_viewed_products') ) {
	function mrblack_shop_others_recently_viewed_products() {
        $reflection = new ReflectionClass('MrBlack_Shop_Others_Recently_Viewed_Products');
        return $reflection->newInstanceWithoutConstructor();
	}
}

MrBlack_Shop_Others_Recently_Viewed_Products::instance();