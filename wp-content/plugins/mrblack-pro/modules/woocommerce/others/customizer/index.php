...
if( !class_exists( 'MrBlack_Pro_Customizer_Others' ) ) {

    class MrBlack_Pro_Customizer_Others {
             ...
             */
                $wp_customize->add_section(
                    new MrBlack_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Others', 'mrblack-pro'),
...
if( !function_exists('mrblack_customizer_others') ) {
	function mrblack_customizer_others() {
		return MrBlack_Pro_Customizer_Others::instance();
	}
}

mrblack_customizer_others();