...
if( ! function_exists( 'mrblack_shop_woo_loop_product_custom_type' ) ) {

	function mrblack_shop_woo_loop_product_custom_type($product_id) {
        ...
        if( $product_show_custom_type ) {
            ...
            if(isset($settings['custom-product-type']) && $settings['custom-product-type'] != '') {
                ...
                $woo_others_settings = mrblack_woo_others()->woo_default_settings();
    ...
    add_action( 'mrblack_woo_before_product_thumb_image', 'mrblack_shop_woo_loop_product_custom_type', 10, 1 );
