...
if( !class_exists( 'MrBlack_Shop_Others_Custom_Product_Type' ) ) {

    class MrBlack_Shop_Others_Custom_Product_Type {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( mrblack_is_file_in_theme( __FILE__ ) ) {
                    return MRBLACK_MODULE_DIR . '/woocommerce/others/custom-product-type/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( mrblack_is_file_in_theme( __FILE__ ) ) {
                    return MRBLACK_MODULE_URI . '/woocommerce/others/custom-product-type/';
                } else {
...
if( !function_exists('mrblack_shop_others_custom_product_type') ) {
	function mrblack_shop_others_custom_product_type() {
        $reflection = new ReflectionClass('MrBlack_Shop_Others_Custom_Product_Type');
        return $reflection->newInstanceWithoutConstructor();
	}
}

MrBlack_Shop_Others_Custom_Product_Type::instance();