<?php
    ...
    <?php
    mrblack_template_part( 'post', 'templates/'.$Post_Style.'/parts/category', '', $template_args );
    if( $template_args['enable_title'] ) :
        mrblack_template_part( 'post', 'templates/post-extra/title', '', $template_args );
    endif;

    mrblack_template_part( 'post', 'templates/'.$Post_Style.'/parts/author_bio', '', $template_args );

    mrblack_template_part( 'post', 'templates/post-extra/content', '', $template_args );
    ?>
