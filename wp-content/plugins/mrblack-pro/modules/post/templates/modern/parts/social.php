...
<div class="single-entry-social-share"><?php
	$output = '<div class="share">';
        ...
        $output .= esc_html__('Share Article:', 'mrblack-pro');
		...
		$output .= '<ul class="wdt-share-list">';
			...
			$output .= '<li><a href="http://twitter.com/share?text='.esc_attr($title).'&amp;url='.esc_attr($link).'" class="wdt-icon-ext-x-icon" target="_blank"></a></li>';
	...
	$output .= '</div>';
	echo mrblack_html_output($output); ?></div><!-- Entry Social Share -->