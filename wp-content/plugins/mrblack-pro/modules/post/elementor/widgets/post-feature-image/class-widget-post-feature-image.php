...
class Elementor_Post_Feature_Image extends MrBlackElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Feature Image', 'mrblack-pro');
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section( 'wdt_section_general', array(
            ...
            $this->add_control( 'enable_lightbox', array(
                ...
                'label'        => esc_html__('Enable Lightbox?', 'mrblack-pro'),
                'label_on'     => esc_html__( 'Yes', 'mrblack-pro' ),
                'label_off'    => esc_html__( 'No', 'mrblack-pro' ),
                'return_value' => 'yes',
                'default'      => '',
				'description' => esc_html__('YES! to enable lightbox preview feature.', 'mrblack-pro')
            ) );
    ...
    protected function render() {
		...
		$out .= '<div class="'.$el_class.'">';
            $out .= mrblack_get_template_part( 'post', 'templates/'.$Post_Style.'/parts/image', '', $template_args );
		$out .= '</div>';
