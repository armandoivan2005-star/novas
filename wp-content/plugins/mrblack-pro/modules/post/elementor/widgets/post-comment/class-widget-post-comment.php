...
class Elementor_Post_Comments extends MrBlackElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Comments', 'mrblack-pro');
    }
    ...
    protected function render() {
		...
		$out .= '<div class="entry-comments-wrapper '.$style.' '.$el_class.'">';
            $out .= mrblack_get_template_part( 'post', 'templates/'.$Post_Style.'/parts/comment', '', $template_args );
		$out .= '</div>';
