...
class Elementor_Post_Socials extends MrBlackElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Socials', 'mrblack-pro');
    }
    ...
    protected function render() {
		...
		$out .= '<div class="entry-social-share-wrapper '.$style.' '.$el_class.'">';
			$out .= mrblack_get_template_part( 'post', 'templates/post-extra/social', '', $template_args );
		$out .= '</div>';
