...
class Elementor_Post_Title extends MrBlackElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Title', 'mrblack-pro');
    }
    ...
    protected function render() {
		...
		$out .= '<div class="entry-title-wrapper '.$el_class.'">';
            $out .= mrblack_get_template_part( 'post', 'templates/post-extra/title', '', $template_args );
		$out .= '</div>';
