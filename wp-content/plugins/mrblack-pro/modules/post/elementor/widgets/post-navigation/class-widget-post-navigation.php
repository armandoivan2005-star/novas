...
class Elementor_Post_Navigation extends MrBlackElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Navigation', 'mrblack-pro');
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section( 'wdt_section_general', array(
            ...
            $this->add_control( 'navi_class', array(
                ...
                'label'       => esc_html__('Select Navigation type', 'mrblack-pro'),
                'default' => 'type1',
                'options' => array(
    ...
    protected function render() {
		...
		$out .= '<div class="entry-post-navigation-wrapper '.$el_class.'">';
            $out .= mrblack_get_template_part( 'post', 'templates/post-extra/navigation', '', $template_args );
		$out .= '</div>';
		echo $out;
	}
