...
class Elementor_Post_Author extends MrBlackElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Author', 'mrblack-pro');
    }
    ...
    protected function render() {
		...
		$out .= '<div class="entry-author-wrapper '.$style.' '.$el_class.'">';
            $out .= mrblack_get_template_part( 'post', 'templates/'.$Post_Style.'/parts/author', '', $template_args );
		$out .= '</div>';
