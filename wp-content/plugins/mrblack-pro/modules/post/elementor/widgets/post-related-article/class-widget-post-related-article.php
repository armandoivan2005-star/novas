...
class Elementor_Post_Related_Article extends MrBlackElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Related Article', 'mrblack-pro');
    }
    ...
    protected function render() {
        ...
        $out .= mrblack_get_template_part( 'post', 'templates/post-extra/related_article', '', $template_args );
