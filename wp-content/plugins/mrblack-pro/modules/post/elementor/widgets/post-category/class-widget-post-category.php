...
class Elementor_Post_Categories extends MrBlackElementorWidgetBase {

    public function get_name() {
        return 'wdt-post-categories';
    }

    public function get_title() {
        return esc_html__('Post - Categories', 'mrblack-pro');
    }
    ...
    protected function render() {
		...
		$out .= '<div class="entry-categories-wrapper '.$style.' '.$el_class.'">';
            $out .= mrblack_get_template_part( 'post', 'templates/'.$Post_Style.'/parts/category', '', $template_args );
		$out .= '</div>';
