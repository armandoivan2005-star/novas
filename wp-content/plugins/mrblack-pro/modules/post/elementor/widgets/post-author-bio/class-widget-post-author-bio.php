...
class Elementor_Post_Author_Bio extends MrBlackElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Author Bio', 'mrblack-pro');
    }
    ...
    protected function render() {
		...
		$out .= '<div class="entry-author-bio-wrapper '.$el_class.'">';
            $out .= mrblack_get_template_part( 'post', 'templates/'.$Post_Style.'/parts/author_bio', '', $template_args );
		$out .= '</div>';
