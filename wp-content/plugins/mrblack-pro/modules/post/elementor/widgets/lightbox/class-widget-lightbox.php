...
class Elementor_Lightbox extends MrBlackElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Lightbox Image', 'mrblack-pro');
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section( 'wdt_section_general', array(
            ...
            $this->add_control( 'url', array(
                ...
                'label'       => esc_html__('Choose Image', 'mrblack-pro'),
				'default'	  => array( 'url' => \Elementor\Utils::get_placeholder_image_src(), ),
                'description' => esc_html__( 'Choose any one image from media.', 'mrblack-pro' ),
            ) );
            ...
            $this->add_control( 'title', array(
                ...
                'default'     => '',
				'description' => esc_html__('Put the image title on preview.', 'mrblack-pro'),
            ) );
            ...
            $this->add_control( 'align', array(
                ...
                'default' => 'alignnone',
                'options' => array(
                    'alignnone'   => esc_html__('None', 'mrblack-pro'),
                    'alignleft'	  => esc_html__('Left', 'mrblack-pro'),
