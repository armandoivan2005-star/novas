...
class MrBlack_Widget_Advance_Field extends WP_Widget {

    #1.constructor
	function __construct() {
		$widget_options = array(
			'classname'   => 'widget_advance_field',
			'description' => esc_html__('To add advance field', 'mrblack-pro')
		);

        $theme_name =  defined('MRBLACK_THEME_NAME') ? MRBLACK_THEME_NAME : 'MrBlack';
		parent::__construct( false, $theme_name . esc_html__(' Advanced Fields','mrblack-pro'), $widget_options );
	}
	...
	?>
		...
		<p>
        	<label for="<?php echo esc_attr($this->get_field_id('sub_title')); ?>">
        		<?php esc_html_e('Sub Title:','mrblack-pro');?>
		...
		<p>
        	<label for="<?php echo esc_attr($this->get_field_id('description')); ?>">
        		<?php esc_html_e('Description:','mrblack-pro');?>
		...
		<p>
        	<label for="<?php echo esc_attr($this->get_field_id('button_text')); ?>">
        		<?php esc_html_e('Button Text:','mrblack-pro');?>
		...
		<p>
        	<label for="<?php echo esc_attr($this->get_field_id('button_url')); ?>">
        		<?php esc_html_e('Button Link:','mrblack-pro');?>
		...
		<p>        
			...
			<label for="<?php echo esc_attr($this->get_field_id('image_url')); ?>">
        		<?php esc_html_e('Image Link:','mrblack-pro');?>
